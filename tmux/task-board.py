...
关键词，再补一两个词说明在做什么（如 mr202-fwd-compat-squash、12704-outcome-judge），
而不是 review、handoff 这类泛泛的动作词。窗口是从可搜索的列表里挑的，值得以后用来搜索的
词才写进去，不要为了凑满长度而堆词。不能和 taken_names 里的重复。其他窗口 name 留空字符串。
